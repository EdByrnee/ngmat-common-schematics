export function insertInsideConstructor(insersion:string, original:string): string{
    ...
    let end_of_cons_num = start_of_cons_str.search("{") + 1 +  start_of_cons_num;

    return original = original.substring(0,end_of_cons_num) + "\n" + insersion + "\n\n" + original.substring(end_of_cons_num)
